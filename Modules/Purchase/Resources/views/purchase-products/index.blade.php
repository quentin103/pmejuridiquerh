        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addProductPermission == 'all' || $addProductPermission == 'added')
                    <x-forms.link-primary :link="route('purchase-products.create')" class="mr-3 openRightModal float-left"
                        icon="plus">
                        @lang('app.add')
                        @lang('app.product')
            ...
            @if (in_array('client', user_roles()) && $addOrderPermission == 'all')
                <div class="btn-group" role="group">
                    <x-forms.link-primary :link="route('purchase-products.cart')" icon="shopping-bag">
                        @lang('app.cart') <span
            ...
            @if (!in_array('client', user_roles()))
                <x-datatable.actions>
                    ...
                    <div class="select-status mr-3 d-none status-quick-action" id="change-product-status">
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('purchase-products.destroy', ':id') }}";
                    url = url.replace(':id', id);
