...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex flex-column">
            <div>
                <x-alert type="warning" icon="info-circle"> @lang('modules.tasks.task_missed_deadline_column') </x-alert>
            </div>
            ...
            <div class="d-grid d-lg-flex d-md-flex action-bar align-items-center mt-3 ">
                ...
                <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                    ...
                    <a href="{{ route('employee-wise-task-report') }}" class="tw-bg-[#838383] tw-p-2 px-3 hover:tw-bg-[#838383]/70  hover:tw-text-white  tw-rounded-md !tw-text-white  f-14 btn-active" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        ...
        $('#status, #field, #employee, #assignedTo')
            .on('change keyup',
                function() {
                    if ($('#status').val() != "all") {
